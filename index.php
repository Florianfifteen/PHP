...
$erreurs = "";
$db = new PDO('mysql:host=localhost;dbname=todolist;charset=utf8', 'florian', 'glpi');
...
if (isset($_POST['creer_tache'])) { // On vérifie que la variable POST existe
    if (empty($_POST['creer_tache'])) {  // On vérifie qu'elle as une valeure
        ...
        $db->exec("INSERT INTO tache(tache) VALUES('$taches')"); // On insère la tâche dans la base de donnée
    }
}
